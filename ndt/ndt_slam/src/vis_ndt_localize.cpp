...
static pcl::PointCloud<pcl::PointXYZI> map, limited_map;
...
static void points_callback(const sensor_msgs::PointCloud2::ConstPtr& input)
{
	...
	if(map_p.x > (current_pose.x - 10.0) && map_p.x < (current_pose.x + 10.0) &&
      ...
      pcl::PointCloud<pcl::PointXYZI>::Ptr limited_map_ptr(new pcl::PointCloud<pcl::PointXYZI>(limited_map));

      ndt.setInputTarget(limited_map_ptr);
      isMapUpdate = false;
    }
